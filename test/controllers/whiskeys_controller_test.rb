...
class WhiskeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create whiskey" do
    assert_difference('Whiskey.count') do
      post whiskeys_url, params: { whiskey: { cost: @whiskey.cost, country: @whiskey.country, extracts: @whiskey.extracts, name: @whiskey.name, smoked: @whiskey.smoked, softness: @whiskey.softness, whiskey_type: @whiskey.whiskey_type } }
    end
  ...
  test "should update whiskey" do
    patch whiskey_url(@whiskey), params: { whiskey: { cost: @whiskey.cost, country: @whiskey.country, extracts: @whiskey.extracts, name: @whiskey.name, smoked: @whiskey.smoked, softness: @whiskey.softness, whiskey_type: @whiskey.whiskey_type } }
